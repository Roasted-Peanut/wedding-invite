...
export const WEDDING_DATES = {
  BRIDE_CEREMONY: new Date("2026-09-20T07:30:00"),
  GROOM_CEREMONY: new Date("2026-09-20T10:30:00"),
};
...
export const EVENT_LOCATIONS = {
  GROOM: {
    ...
    mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1328.5691732733314!2d105.8798757521265!3d20.718173871872988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135c9006b91e13b%3A0xffc6e8637f2e1c7!2zTmjDoCB2xINuIGhvw6EgdGjDtG4g4buobmcgQ-G7rQ!5e0!3m2!1svi!2s!4v1755502801120!5m2!1svi!2s",
  },
  BRIDE: {
    address: "Tư gia nhà gái, 123 Đường Hoa Mai, Quận Phú Nhuận, TP. Hồ Chí Minh",
    mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3727.302251765549!2d106.42828327613498!3d20.90015598071724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313585d23afcde1b%3A0xe5b7baddd3b52bae!2zMDk2IE5ndXnhu4VuIEjhuqNpIFRoYW5oLCBUVC4gVGhhbmggSMOgLCBUaGFuaCBIw6AsIEjhuqNpIETGsMahbmcsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1755503369215!5m2!1svi!2s",
  },
};
...
export const LOVE_JOURNEY = [
  {
    ...
    description: "Chúng ta tình cờ gặp nhau tại quán cà phê nhỏ, và từ đó câu chuyện bắt đầu.",
    image: "https://moonflowerhanoi.com/wp-content/uploads/2023/06/bo-hoa-cuoi-tulip-nu-cuoi-rang-ro.jpg",
  },
  {
    date: "14/02/2020",
    title: "Buổi hẹn hò đầu tiên",
    description: "Valentine đáng nhớ với những kỷ niệm ngọt ngào không thể quên.",
    image: "https://moonflowerhanoi.com/wp-content/uploads/2023/06/bo-hoa-cuoi-tulip-nu-cuoi-rang-ro.jpg",
  },
  {
    date: "20/09/2023",
...
export const GIFT_INFO = [
  {
    ...
    name: "Chú Rể",
    account: "12349854060",
    qrSrc: "src/assets/QRcode.jpg",
    altText: "Mã QR Techcombank của Chú Rể",
  },
  {
    ...
    name: "Cô Dâu",
    account: "12349854060",
    qrSrc: "https://qrcode-gen.com/images/qrcode-default.png",
    altText: "Mã QR Techcombank của Cô Dâu",
  },
];

// Introduction images
export const INTRO_IMAGES = {
  GROOM: "https://png.pngtree.com/png-clipart/20240428/original/pngtree-cute-couple-cat-sleeping-and-licking-cartoon-png-image_14963738.png",
  BRIDE: "https://png.pngtree.com/png-clipart/20240428/original/pngtree-cute-couple-cat-sleeping-and-licking-cartoon-png-image_14963738.png",
};

// Messages
export const MESSAGES = {
  THANKS: "Sự hiện diện của quý vị là niềm vinh hạnh lớn đối với gia đình chúng tôi.",
  TIMELINE_TITLE: "Ngày này củng đã tới...!",
  TIMELINE_TEXT: "Thật vui vì được gặp và đón tiếp các bạn trong một dịp đặc biệt - Ngày cưới của chúng mình. Chúng mình muốn gửi đến bạn những lời cảm ơn sâu sắc nhất và để bạn biết rằng chúng mình rất hạnh phúc khi thấy bạn ở đó. Cảm ơn các bạn rất nhiều vì sự hiện diện cùng những lời chúc tốt đẹp mà bạn đã dành cho chúng mình nha!",
  LOVE_JOURNEY_TITLE: "Hành Trình Tình Yêu",
  GUESTBOOK_TITLE: "Sổ Lưu Bút",
  GUESTBOOK_ERROR: "Vui lòng nhập đầy đủ tên và lời chúc.",
